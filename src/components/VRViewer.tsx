...
import { Viewer, SceneConfig } from '@/lib/three/Viewer';
...
const SCENES: Record<string, SceneConfig> = {
    'salon': {
        ...
        portals: [
            { id: 'cocina', position: { x: 0.707, y: -0.1, z: -0.707 }, label: 'Ir a Cocina' }
        ]
    },
    'cocina': {
        id: 'cocina',
        ...
        portals: [
            { id: 'salon', position: { x: -0.707, y: -0.1, z: 0.707 }, label: 'Volver al Salón' }
        ]
    }
};
